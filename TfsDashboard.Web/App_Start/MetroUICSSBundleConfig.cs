...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(TfsDashboard.Web.App_Start.MetroUICSSBundleConfig), "RegisterBundles")]
...
namespace TfsDashboard.Web.App_Start
{
	public class MetroUICSSBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new ScriptBundle("~/bundles/metro-ui").Include("~/Scripts/metro-ui/jquery.ui.widget.js").Include("~/Scripts/metro-ui/metro.min.js"));
